	...
	<div class="container" >
		...
		<div class="panel panel-default col-sm-5" id="container_cadastro">
			...
			<div class="panel-body">
				...
				<form id="form_cadastroCliente" action="salvarDadosPessoais?idTipoAcesso=${usuarioLogado.tipo_acesso.id}"  method="post">
				   <input type="hidden" value="${usuarioLogado.id}" name="usuario">
					...
					<div class="form-group">
						...
						<input type="text"   class="form-control" id="cpfCnpj" placeholder="Digite seu cpf" name="cpfCnpj">
					</div>
					
					<div class="form-group">
						<label for="rg">RG:</label>
						<input type="text"  class="form-control" id="rgIe" placeholder="Digite  seu RG" name="rgIe">
					</div>
