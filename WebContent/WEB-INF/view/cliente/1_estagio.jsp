				...
				<div class="fontawesome-list-wrap">
					...
					<section id="solicitacao">
						...
						<p>Você irá preencher o seu endereço para o prestador de
							serviço saber onde que você reside e assim o mesmo lhe prestar o
							serviço, que você está solicitando.</p>
						<br>

						<div class="row form-group" style="float: right;">
							<div class="col col-md-3">
								<button type="button" data-toggle="modal" data-target="#myModal"
									class="btn btn-primary">&nbsp; Usar endereço já
									cadastrado</button>
							</div>
						</div>
						<br> <br> <br>
						...
						<div class="row form-group">
							...
							<div class="col-12 col-md-5">
								<input type="text" name="n_casa" id="n_casa"
									class="form-control">
							</div>
						</div>
						...
						<div class="row form-group" style="float: right;">
							<div class="col col-md-3">
								<a href="SegundoEstagio"><button type="button"
