			...
			<div class="container-fluid">
				...
				<div class="fontawesome-list-wrap">
					...
					<section id="solicitacao">
						...
						<br>
						<p>Você irá escolher um dos seus endereço cadastrados para que o prestador de
							serviço saber onde que você reside. Apos disso, você ficara no aguardo da confirmação do prestador. Caso o prestador aceite a sua solicitação, irá 
