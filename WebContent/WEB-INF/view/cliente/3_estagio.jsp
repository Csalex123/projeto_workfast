					...
					<section>
						...
						<div class="row form-group">
							...
							<div class="col-12 col-md-5">
								<p>
									<img src="<%=request.getContextPath()%>/resources/img/icon_cliente/icone_mecanico.png" alt="Marcílio God"
						...
						<div class="row form-group">
							<div class="col col-md-5">
								<label for="select" class=" form-control-label"
									style="font-weight: bold;">Profissão do prestador de
									serviço:</label>
							</div>
							<div class="col-12 col-md-5">
								<p>Eletricista</p>
						...
						<div class="row form-group">
							<div class="col col-md-5">
								<label for="select" class=" form-control-label"
									style="font-weight: bold;">Data do Serviço:</label>
							</div>
							<div class="col-12 col-md-5">
								<p>21/12/2018</p>
							</div>
						...
						<div class="row form-group">
							<div class="col col-md-5">
								<label for="select" class=" form-control-label"
									style="font-weight: bold;">Valor do Serviço:</label>
							</div>
							<div class="col-12 col-md-5">
								<p>R$ 150,00</p>
							</div>
