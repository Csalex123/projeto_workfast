...
<title>WorkFast</title>
	...
	<script type="text/javascript" src="<%=request.getContextPath()%>/resources/js/entrar.js"></script>
	
	<!-- Código css desta Página(Página de cadastro) -->	
	<link rel="stylesheet" type="text/css" href="<%=request.getContextPath()%>/resources/css/entrar.css"/>
	...
	<div class="container" >
		...
		<div class="panel panel-default col-sm-4" id="container_login">
			...
			<div class="panel-body">
				...
				<div>
					<a href="" style="color: red; font-weight: bold;" data-toggle="modal" data-target="#modal_recuperar_senha" >Esqueceu sua senha?</a>	
				</div>		

				<div class="form-group"> 
					<div class="col-sm-offset-2 col-sm-10">
						<button type="submit" id="button_login" class="btn btn-primary"> Entrar</button>
					</div>
				</div>
				...
				<div>
					<p id="p_mensagem">
						...
						<a href="cadastro" style="color: green;" data-toggle="tooltip" data-placement="top" title="Se clicar você será redirecionado para a página de cadastro">Cadastrar-se</a>
					</p>
				</div>
...
<!-- Modal -->
<div class="modal fade" id="modal_recuperar_senha" role="dialog" media="all" data-backdrop="static">
			...
			<div class="modal-body">
				<form id="form_recuperar_senha">
					<div class="form-group">
						...
						<input type="email" name="email2" class="form-control"  placeholder="Digite seu e-mail">
					</div>
