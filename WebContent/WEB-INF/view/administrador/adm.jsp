                                ...
                                <div class="table-data__tool-left">
                                     <form>
                                         <div class="form-group">
                                                ...
                                                <input type="text" id="txtPesquisa" name="pesquisa" placeholder="Pesquise aqui.." class="form-control">
                                                
                                            </div>
                                    </form>
                                </div>
                                <div class="table-data__tool-right">
                                    <button class="au-btn au-btn-icon au-btn--azul au-btn--small" style="background-color: ">
                                        <i class="zmdi zmdi-plus"></i>Novo Administrador</button>
